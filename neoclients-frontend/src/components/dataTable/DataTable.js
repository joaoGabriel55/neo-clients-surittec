...
function EnhancedTableHead(props) {
  const { userLogged, headCells, classes, onSelectAllClick, order, orderBy, numSelected, rowCount, onRequestSort } = props;
    ...
    <TableHead>
      <TableRow>
        <TableCell padding="checkbox">
          {userLogged.profile === 'ROLE_ADMIN' ? <Checkbox
...
const EnhancedTableToolbar = (props) => {
  ...
  const { title, selected, onDeleteData, setSelectedEmpty } = props;
              ...
              {stableSort(rows, getComparator(order, orderBy))
                .map((row, index) => {
                  ...
                  return (
                    ...
                    >
                      <section style={{ display: 'contents' }} onClick={() => handleViewClick(row)}>
                        <TableCell padding="checkbox">
